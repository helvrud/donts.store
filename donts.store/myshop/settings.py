...
SHOP_TUTORIAL = 'i18n_polymorphic'
...
DEBUG = True
if socket.gethostname() == 'rauf2.beget.ru':
    DEBUG = False

#~ ALLOWED_HOSTS = ['*']
ALLOWED_HOSTS = ['owain.natur.cuni.cz', 'donts.store', 'kunsthaus.ru', '127.0.0.1', 'localhost']
...
CMS_TEMPLATES = [
    ('myshop/pages/fashion.html', _("Fashion Vitality Theme")),
    ('myshop/pages/contact.html', _("Contact Form")),
...
try:
    ...
    pass
DJANGOCMS_GOOGLEMAP_API_KEY = 'AIzaSyBY3sCCxThoqcVqjBLluqVLetEVLjNOvzU'


CONNECTED_ACCOUNTS_INSTAGRAM_CONSUMER_KEY = 'cf6faaba4d5d48bab3726aec50b9d706'
CONNECTED_ACCOUNTS_INSTAGRAM_CONSUMER_SECRET = 'fad3606c2ced4816869ad1849ffe7c1b'
...
DJANGO_EMAIL_HOST = 'smtp.yandex.com'
DJANGO_EMAIL_PORT = 465
DJANGO_EMAIL_USER = 'sales@donts.store'
DJANGO_EMAIL_PASSWORD = 'Mas_tq12'
DJANGO_EMAIL_USE_TLS = True
DJANGO_EMAIL_FROM = 'sales@donts.store'
DJANGO_EMAIL_REPLY_TO = 'sales@donts.store'
...
DEFAULT_FROM_EMAIL = 'sales@donts.store'
EMAIL_HOST = 'smtp.yandex.com'
EMAIL_HOST_USER = 'sales@donts.store'
EMAIL_REPLY_TO = 'sales@donts.store'
EMAIL_HOST_PASSWORD = 'Mas_tq12'
EMAIL_PORT = 465
#~ EMAIL_USE_TLS = True
EMAIL_USE_SSL = True
EMAIL_BACKEND = 'post_office.EmailBackend'
...
#~ print(EMAIL_HOST, EMAIL_PORT, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD,  DEFAULT_FROM_EMAIL, EMAIL_REPLY_TO)


RECAPTCHA_PUBLIC_KEY = '6Le94XQUAAAAAGcM5AEPYoMgnTv146ipLQDnaSzR'
RECAPTCHA_PRIVATE_KEY = '6Le94XQUAAAAAOhoJXVyjnWWQMN9SkJE9tWVeow'
