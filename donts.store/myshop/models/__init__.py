...
__all__ = ['ShippingAddress', 'BillingAddress', 'Cart', 'CartItem', 'Customer', 'OrderItem',
           'Commodity', 'SmartCard', 'SmartPhoneModel', 'SmartPhoneVariant', 'ScooterModel', 'ScooterVariant', 'Delivery', 'DeliveryItem']
...
from .i18n_polymorphic.scooter import ScooterModel, ScooterVariant
from .i18n_polymorphic.khimage import KhimageModel, KhimageVariant


from shop.models.defaults.delivery import Delivery, DeliveryItem
__all__.extend(['SmartCard', 'SmartPhoneModel', 'ScooterModel', 'KhimageModel', 'KhimageVariant', 'SmartPhoneVariant', 'ScooterVariant', 'Delivery', 'DeliveryItem'])
