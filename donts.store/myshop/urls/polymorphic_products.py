...
from myshop.serializers import (AddScooterToCartSerializer, AddSmartPhoneToCartSerializer, CatalogSearchSerializer)
...
urlpatterns = [
    ...
    url(r'^(?P<slug>[\w-]+)/add-scooter-to-cart', AddToCartView.as_view(
        serializer_class=AddScooterToCartSerializer,
    )),
