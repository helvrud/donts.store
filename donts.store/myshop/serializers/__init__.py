...
if settings.SHOP_TUTORIAL in ['commodity', 'i18n_commodity']:
    ...
    from .polymorphic import (SmartCardSerializer, SmartPhoneSerializer, ScooterSerializer, AddSmartPhoneToCartSerializer, AddScooterToCartSerializer)

    __all__.extend(['SmartCardSerializer', 'SmartPhoneSerializer', 'ScooterSerializer', 'AddSmartPhoneToCartSerializer', 'AddScooterToCartSerializer'])
