...
if settings.SHOP_TUTORIAL in ['i18n_commodity', 'commodity']:
    ...
    from myshop.models import SmartCard, SmartPhoneModel, ScooterModel, Commodity
...
if settings.SHOP_TUTORIAL in ['i18n_polymorphic', 'polymorphic']:
    class ScooterIndex(ProductIndex, indexes.Indexable):
        def get_model(self):
            return ScooterModel
    myshop_search_index_classes.append(ScooterIndex)
